...
vis = 0;
root_dir = '../models';
file_dir = '/tactile_results_grasp';
save_dir = '../saliency_models';
...
%noise
sigma=0.012;
[m,n]=size(face_centers);
p_offset=normrnd(0,sigma,m,n);
normals=normals+p_offset;
...
%%
save_name = strcat('add_1_offset',files_names(i).name(1:end-4));
